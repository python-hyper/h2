...
from hpack.struct import NeverIndexedHeaderTuple, Headers
...
class H2Stream:
    ...
    def send_data(self, data: Union[bytes, memoryview], end_stream: bool = False, pad_length: Optional[int] = None) -> list[Frame]:
        """
    ...
    def remotely_pushed(self, pushed_headers: Headers) -> tuple[list[Frame], list[Event]]:
        """
    ...
    def receive_headers(self, headers: Headers, end_stream: bool, header_encoding: Optional[Union[bool, str]]) -> tuple[list[Frame], list[Event]]:
        """
    ...
    def _build_headers_frames(self,
                              ...
                              hdr_validation_flags: HeaderValidationFlags) -> list[Union[HeadersFrame, ContinuationFrame, PushPromiseFrame]]:
        """
    ...
    def _process_received_headers(self,
                                  ...
                                  header_encoding: Optional[Union[bool, str]]) -> Headers:
        """
    ...
    def _initialize_content_length(self, headers: Headers) -> None:
        """
        ...
        for n, v in headers:
            if n == b'content-length':
                try:
                    ...
                    raise ProtocolError(
                        "Invalid content-length header: %r" % v
                    )
...
def _decode_headers(headers: Headers, encoding: str) -> Headers:
    """
